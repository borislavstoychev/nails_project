...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('DB_NAME', 'nails_db'),
        'USER': os.environ.get('DB_USER', 'admin'),
        'PASSWORD': os.environ.get('DB_PASS', 'borkata'),
...
EMAIL_HOST_PASSWORD = os.environ.get('EMAIL_PASS', '0878799823')
EMAIL_HOST_USER = os.environ.get('EMAIL_USER', 'test.bobby.demo@gmail.com')
EMAIL_PORT = 587
EMAIL_USE_TLS = True
